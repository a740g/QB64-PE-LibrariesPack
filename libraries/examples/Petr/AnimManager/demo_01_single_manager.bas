...
Screen screenImage
_Title "Anim manager demo 01 - single video"

Cls , _RGB32(10, 12, 18)

AnimProbe "001.webp", ok, formatId, widthPx, heightPx, frameCount
If ok = 0 Then
    Print "File 001.webp not found."
    End
End If
...
AnimFreeAll 'erase all animations and free memory
End
